...
```sh
make gd32 GD32_EXAMPLE=i2c_slave GD32_IMPL=registers
cmake --preset gd32-i2c-registers
cmake --build --preset gd32-i2c-registers
```

Desde el directorio del micro: `make EXAMPLE=i2c_slave IMPL=registers`.
